...
switch ($action) {
    ...
    case 'crear_presupuesto':
        ...
        $stmt = $db->prepare("INSERT INTO presupuesto (rubro, monto_asignado, monto_ejecutado, periodo) VALUES (:rubro, :monto_asignado, :monto_ejecutado, :periodo)");
        $stmt->execute([
            ':rubro' => $rubro,
    ...
    case 'editar_presupuesto':
        ...
        $db->prepare("UPDATE presupuesto SET rubro = :rubro, monto_asignado = :monto, monto_ejecutado = :ejecutado, periodo = :periodo WHERE id_presupuesto = :id")
           ->execute([':rubro' => $rubro, ':monto' => $monto_asignado, ':ejecutado' => $monto_ejecutado, ':periodo' => $periodo, ':id' => $id]);
