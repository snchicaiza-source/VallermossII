...
<head>
    ...
    <style>
        ...
        .pres-grid { display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 1rem; }
        ...
        <section class="card">
            ...
            <div class="card-body">
                <form action="../../controllers/AdministradorController.php" method="POST" class="pres-grid">
                    ...
                    <div class="form-group">
                        <label for="monto_ejecutado">Monto Ejecutado</label>
                        <div class="input-money">
                            <span>$</span>
                            <input type="number" step="0.01" min="0" id="monto_ejecutado" name="monto_ejecutado" placeholder="0.00" value="<?= $editando ? htmlspecialchars($editando['monto_ejecutado']) : '' ?>" required>
                        </div>
                    </div>
